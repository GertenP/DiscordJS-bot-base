...
export async function ticketModalSubmit(interaction) {
    if (interaction.customId === "ticket_modal") {
        const user = interaction.user.username;
        const problem_title = interaction.fields.getTextInputValue("header");
        const problem_description = interaction.fields.getTextInputValue("description");
